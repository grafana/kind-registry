...
lineage: {
	seqs: [{
		schemas: [{
			...
			// is insufficient.
			revision?: >=-9223372036854775808 & <=9223372036854775807 & int @grafanamaturity(NeedsExpertReview)
			...
			fiscalYearStartMonth?: int & >=0 & <=255 & <12 | *0
			...
			schemaVersion: int & >=0 & <=65535 | *36
			// Version of the dashboard, incremented each time the dashboard is updated.
			version?: >=0 & <=4294967295 & int @grafanamaturity(NeedsExpertReview)
			...
			#AnnotationQuery: {
				...
				builtIn: int & >=0 & <=255 | *0 @grafanamaturity(NeedsExpertReview)
				...
				showIn:    int & >=0 & <=255 | *0 @grafanamaturity(NeedsExpertReview)
			...
			#VariableModel: {
				...
				index:         int & >=-2147483648 & <=2147483647 | *-1
				state:         #LoadingState
				error?: {
					...
				}
			...
			#GridPos: {
				// Panel
				h: int & >=0 & <=4294967295 & >0 | *9 @grafanamaturity(NeedsExpertReview)
				// Panel
				w: int & >=0 & <=4294967295 & >0 & <=24 | *12 @grafanamaturity(NeedsExpertReview)
				// Panel x
				x: int & >=0 & <=4294967295 & >=0 & <24 | *0 @grafanamaturity(NeedsExpertReview)
				// Panel y
				y: int & >=0 & <=4294967295 & >=0 | *0 @grafanamaturity(NeedsExpertReview)
				// true if fixed
			...
			#Threshold: {
				...
				index?: >=-2147483648 & <=2147483647 & int @grafanamaturity(NeedsExpertReview)
				// TODO docs
			...
			#RangeMap: {
				...
				options: {
					...
					from:   >=-1.797693134862315708145274237317043567981e+308 & <=1.797693134862315708145274237317043567981e+308 @grafanamaturity(NeedsExpertReview)
					to:     >=-1.797693134862315708145274237317043567981e+308 & <=1.797693134862315708145274237317043567981e+308 @grafanamaturity(NeedsExpertReview)
			...
			#ValueMappingResult: {
				...
				color?: string
				icon?:  string
				index?: >=-2147483648 & <=2147483647 & int
			} @cuetsy(kind="interface")
			...
			#Snapshot: {
				...
				// TODO docs
				id: >=0 & <=4294967295 & int @grafanamaturity(NeedsExpertReview)
				// TODO docs
				key: string @grafanamaturity(NeedsExpertReview)
				// TODO docs
				name: string @grafanamaturity(NeedsExpertReview)
				// TODO docs
				orgId: >=0 & <=4294967295 & int @grafanamaturity(NeedsExpertReview)
				// TODO docs
				updated: t.Time & {
					string
				}
				...
				url?: string @grafanamaturity(NeedsExpertReview)
				// TODO docs
				userId: >=0 & <=4294967295 & int @grafanamaturity(NeedsExpertReview)
			} @grafanamaturity(NeedsExpertReview)
			...
			#Panel: {
				...
				repeatPanelId?: >=-9223372036854775808 & <=9223372036854775807 & int @grafanamaturity(NeedsExpertReview)
